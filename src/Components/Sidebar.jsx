...
const Sidebar = ({ isOpen, setIsOpen, user }) => {
  ...
  const menuItems = [
    ...
    { path: '/weekly_planner', icon: HiOutlineChartBar, label: 'Weekly Planner' },
    { path: '/collab_space', icon: HiOutlineUserGroup, label: 'Collab Space' },
  ...
  return (
    <>
      ...
      <motion.div 
        initial={{ x: -200 }}
        animate={{ x: 0 }}
        className={`fixed left-0 top-0 h-screen bg-white dark:bg-gray-900 shadow-lg transition-all duration-300 z-30
          ${isOpen ? 'w-64' : 'w-20'} 
